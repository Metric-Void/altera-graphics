...
module final_project_soc_mm_interconnect_0 (
	...
	wire  [108:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [108:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> otg_hpi_cs_s1_agent:cp_data
	...
	wire   [16:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> otg_hpi_reset_s1_agent:cp_channel
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> otg_hpi_address_s1_agent:cp_valid
	wire  [108:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> otg_hpi_address_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // otg_hpi_address_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [16:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> otg_hpi_address_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> otg_hpi_address_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> otg_hpi_address_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> vga_vs_s1_agent:cp_valid
	wire  [108:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> vga_vs_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // vga_vs_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [16:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> vga_vs_s1_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> vga_vs_s1_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> vga_vs_s1_agent:cp_endofpacket
	...
	wire  [108:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [108:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_015:sink_data
	...
	wire          otg_hpi_address_s1_agent_rp_valid;                                                  // otg_hpi_address_s1_agent:rp_valid -> router_017:sink_valid
	wire  [108:0] otg_hpi_address_s1_agent_rp_data;                                                   // otg_hpi_address_s1_agent:rp_data -> router_017:sink_data
	wire          otg_hpi_address_s1_agent_rp_ready;                                                  // router_017:sink_ready -> otg_hpi_address_s1_agent:rp_ready
	wire          otg_hpi_address_s1_agent_rp_startofpacket;                                          // otg_hpi_address_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          otg_hpi_address_s1_agent_rp_endofpacket;                                            // otg_hpi_address_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          vga_vs_s1_agent_rp_valid;                                                           // vga_vs_s1_agent:rp_valid -> router_018:sink_valid
	wire  [108:0] vga_vs_s1_agent_rp_data;                                                            // vga_vs_s1_agent:rp_data -> router_018:sink_data
	wire          vga_vs_s1_agent_rp_ready;                                                           // router_018:sink_ready -> vga_vs_s1_agent:rp_ready
	wire          vga_vs_s1_agent_rp_startofpacket;                                                   // vga_vs_s1_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          vga_vs_s1_agent_rp_endofpacket;                                                     // vga_vs_s1_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          otg_hpi_address_s1_agent_rdata_fifo_src_valid;                                      // otg_hpi_address_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] otg_hpi_address_s1_agent_rdata_fifo_src_data;                                       // otg_hpi_address_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          otg_hpi_address_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_015:in_0_ready -> otg_hpi_address_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> otg_hpi_address_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> otg_hpi_address_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // otg_hpi_address_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> otg_hpi_address_s1_agent:rdata_fifo_sink_error
	wire          vga_vs_s1_agent_rdata_fifo_src_valid;                                               // vga_vs_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] vga_vs_s1_agent_rdata_fifo_src_data;                                                // vga_vs_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          vga_vs_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_016:in_0_ready -> vga_vs_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> vga_vs_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> vga_vs_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // vga_vs_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> vga_vs_s1_agent:rdata_fifo_sink_error
