...
#create_generated_clock -name {fp_system|sdram_pll|sd1|pll7|clk[0]} -source [get_pins {fp_system|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 4 -phase 0.00 -master_clock {Clk}   [get_pins {fp_system|sdram_pll|sd1|pll7|clk[0]}]
#create_generated_clock -name {fp_system|sdram_pll|sd1|pll7|clk[1]} -source [get_pins {fp_system|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -divide_by 2   -phase 0.00 -master_clock {Clk} [get_pins {fp_system|sdram_pll|sd1|pll7|clk[1]}]
...
#create_generated_clock -name {fp_system|sdram_pll|sd1|pll7|clk[4]} -source [get_pins {fp_system|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 2 -phase -54.00 -master_clock {Clk} [get_pins {fp_system|sdram_pll|sd1|pll7|clk[4]}]
